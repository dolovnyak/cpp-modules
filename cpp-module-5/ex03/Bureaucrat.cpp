...
void Bureaucrat::signForm(Form& form)
{
	...
	{
		std::cout << "<" << _name << "> cannot sign <" << form.getName() << "> because of <" << exception.what() << ">" << std::endl;
	}
}
...
void Bureaucrat::executeForm(const Form& form)
{
	...
	{
		std::cout << "<" << _name << "> execution failure <" << form.getName() << "> because of <" << exception.what() << ">" << std::endl;
	}
}
